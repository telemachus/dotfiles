#!/usr/bin/env bash
# Tweaked for preferences by Peter Aronoff, April 11, 2021.
...
# Set highlight color to blue (which is the default)?
...
# defaults write NSGlobalDomain AppleLanguages -array "en-US" "el"
...
sudo systemsetup -settimezone "American/New_York" >/dev/null
...
# Show icons servers, and removable media on the desktop
defaults write com.apple.finder ShowExternalHardDrivesOnDesktop -bool true
defaults write com.apple.finder ShowMountedServersOnDesktop -bool true
defaults write com.apple.finder ShowRemovableMediaOnDesktop -bool true

# Do not show icon for machine’s own hard drive
...
# Enable smart quotes in Messages
